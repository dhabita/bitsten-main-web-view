 ...
 */
 ...
 function all_market(d) {
     ...
     d.data.forEach(e => {
         ...
         var tddata = '\
<td  ><i class="icon ion-md-star"></i>  <img class="show-xs" src="https://f1.bitsten.com/assets/images/logo/' + coin + '.png"  width="20px"  > ' + coin.toUpperCase() + "<span class='hide-xs'>_" + market.toUpperCase() + "</span>" + '</td>\
